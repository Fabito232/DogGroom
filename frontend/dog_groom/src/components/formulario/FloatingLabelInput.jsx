const FloatingLabelInput = ({ name, label, value, onChange, type = "text", required, disabled, readOnly }) => {
  return (
    <div className="relative mb-4">
      ...
      <label
        htmlFor={name}
        className={`absolute duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-slate-200 dark:bg-gray-900 pl-2 pr-2 pointer-events-none
          ...
          ${value ? 'text-black font-bold' : 'text-gray-500 dark:text-gray-400 peer-focus:text-blue-600 peer-placeholder-shown:text-gray-500'}`}
        style={{ left: '0.50rem' }}
      >
        {label}
      </label>

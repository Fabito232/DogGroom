...
const ListaClientes = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-start justify-start bg-fondo bg-cover">
      <div className="p-12 shadow-lg w-full md:w-200">
        <div className="hadow-md p-16 mb-8 overflow-auto max-h-[790px]" style={{ overflowY: 'auto', WebkitOverflowScrolling: 'touch', scrollbarWidth: 'none'}}>

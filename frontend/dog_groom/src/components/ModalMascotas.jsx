...
import Cliente from '../assets/img_perro.jpg'; // Importa la imagen por defecto o imagen de cliente aquí
    ...
    <div className="fixed inset-0 flex flex-col items-center justify-center bg-black bg-opacity-50 z-50 p-4">
      <div className="bg-gray-300 p-4 rounded-md shadow-lg max-w-6xl relative">
        ...
        <button
          ...
          onClick={() => console.log('Agregar nueva mascota')} // Aquí puedes implementar la lógica para agregar una nueva mascota
        >
          Agregar Mascota
        </button>
